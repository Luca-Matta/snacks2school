import { resolveComponent, openBlock, createElementBlock, normalizeClass, createVNode, createSlots, withCtx, renderSlot, createTextVNode, createElementVNode, toDisplayString, Transition, createBlock, normalizeProps, mergeProps, createCommentVNode, normalizeStyle, Fragment, renderList, resolveDynamicComponent, TransitionGroup, withKeys, withModifiers, version, unref, inject, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, hasInjectionContext, getCurrentInstance, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, toRef, defineAsyncComponent, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
...
let now, todayDate, todayF, self$1;
let _dateObject = {};
let _timeObject = {};
class DateUtils {
  ...
  _initDatePrototypes() {
    Date.prototype.addDays = function(days) {
      return self$1.addDays(this, days);
    };
    Date.prototype.subtractDays = function(days) {
      return self$1.subtractDays(this, days);
    };
    Date.prototype.addHours = function(hours) {
      return self$1.addHours(this, hours);
    };
    Date.prototype.subtractHours = function(hours) {
      return self$1.subtractHours(this, hours);
    };
    Date.prototype.addMinutes = function(minutes) {
      return self$1.addMinutes(this, minutes);
    };
    Date.prototype.subtractMinutes = function(minutes) {
      return self$1.subtractMinutes(this, minutes);
    };
    Date.prototype.getWeek = function() {
      return self$1.getWeek(this);
    };
    Date.prototype.isToday = function() {
      return self$1.isToday(this);
    };
    Date.prototype.isLeapYear = function() {
      return self$1.isLeapYear(this);
    };
    Date.prototype.format = function(format = "YYYY-MM-DD") {
      return self$1.formatDate(this, format);
    };
    Date.prototype.formatTime = function(format = "HH:mm") {
      return self$1.formatTime(this, format);
    };
  }
  removePrototypes() {
...
const WeekdaysHeadings = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["render", render$5]]);
...
const Header = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["render", render$4]]);
...
const Event = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["render", render$3]]);
...
const Cell = /* @__PURE__ */ _export_sfc$1(_sfc_main$2$1, [["render", render$2]]);
const _hoisted_1$1 = {
  key: 0,
...
const AllDayBar = /* @__PURE__ */ _export_sfc$1(_sfc_main$1$1, [["render", render$1]]);
...
const index = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["render", render]]);
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BboFMgWt.mjs')
  }
];
...
const vue_cal_4JhajCN72v = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.component("VueCal", index);
});
const plugins = [
  unhead_KgADcZ0jPj,
  plugin,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-jeJKst-G.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-ubIu56qF.mjs'));
