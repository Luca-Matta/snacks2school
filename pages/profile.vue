    ...
    <ion-content :fullscreen="true">
      <div>
          ...
          >
            ...
            <div class="flex flex-wrap gap-8">
              ...
              >
                ...
                <div
                  v-if="child.associated_schools.length > 1"
                  class="font-bold"
                >
                  Scuole
                </div>
        ...
        >
          ...
          <div
            class="mx-auto text-center font-bold text-xs md:text-sm !px-4 underline"
          >
            <router-link to="/orders/receipts" class="!text-black opacity-60"
              >Fai clic qui.</router-link
            >
          </div>
        </div>
        <Footer />
