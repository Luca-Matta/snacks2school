<template>
  <ion-page>
    <ion-content :fullscreen="true">
      <div class="flex justify-center items-center bg-[#f5f5f5] h-full pb-16">
        <div class="flex flex-col justify-center items-center">
          ...
          >
            <div class="text-2xl font-semibold !text-black">Registrati</div>
          ...
          Unisciti agli utenti di Snacks2School
            ...
            <form class="mb-3" @submit.prevent="handleSignup">
              ...
              <div class="text-left">
                <label class="text-gray-[#888] text-xs" for="flexCheckDefault">
                  Facendo clic su "Registrati" accetti i nostri
                  <a
                    href=""
                    class="iubenda-nostyle iubenda-noiframe iubenda-embed iubenda-noiframe underline !text-[#888]"
...
const handleSignup = async () => {
  try {
    ...
    const payload = {
      email: email.value,
      username: username.value,
      student_first_name: firstName.value,
      student_last_name: lastName.value,
