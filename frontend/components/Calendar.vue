<template>
  <div class="flex flex-wrap justify-center items-center gap-5">
    ...
    >
      ...
      <div
        class="flex flex-col justify-center items-center text-center h-40 w-40 border border-purple rounded-xl"
      >
        ...
        <div v-if="!content" class="text-purple font-bold">Ordina ora</div>
      </div>
    </div>
  </div>
</template>
