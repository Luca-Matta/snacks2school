<template>
  <div>
    <Navbar />
    <div class="hero text-white pb-6">
      <div
        class="flex flex-col md:flex-row justify-center items-center py-56 gap-8"
      >
        <div class="bg-gray-100 h-32 w-32 rounded-xl">
          <img :src="profile_picture" alt="Profile Picture" />
        </div>
        <div class="flex flex-col gap-2">
          <p class="font-bold text-5xl">{{ first_name }} {{ last_name }}</p>
          <div>
            <p>{{ location }}</p>
      ...
      <div class="py-2" style="background-color: rgba(243, 244, 246, 0.6)">
        <div class="flex justify-center items-center">
          <div class="flex gap-12">
            ...
            <div>
              <img src="../../assets/icons/bio.png" alt="" class="h-20 w-20" />
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="flex flex-col justify-center items-center gap-2">
              ...
              <div class="flex flex-col justify-center items-center">
                <div class="flex items-center justify-center gap-1">
                  <p class="font-bold">Prodotto 1</p>
                  <img
