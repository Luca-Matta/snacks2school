      ...
      <div class="bg-white rounded-3xl shadow-card min-w-96 p-6 mt-12">
        ...
        <form class="mb-3" @submit.prevent="handleLogin">
          ...
          <div class="text-center">
            <button
              type="submit"
              class="btn-yellow w-full font-bold text-white uppercase text-xs shadow-button my-4 mb-2 py-3 px-6 rounded-lg"
            >
              Accedi
            </button>
          </div>
          ...
          <p class="text-sm mt-3 mb-0 text-lead">
            Non hai un account?
            <a href="{% url 'group-choice' %}" class="font-bold">Registrati</a>
          </p>
        </form>
      </div>
    </div>
