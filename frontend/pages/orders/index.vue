  ...
  <div>
    ...
    >
      <div class="text-4xl md:text-6xl lg:text-8xl text-center font-bold mb-4">
        <div>
          <span class="text-brown">Benvenuto</span> nel tuo
          <span class="text-purple">gestionale!</span>
        </div>
        <div class="flex justify-center items-center gap-2 md:gap-6">
          <div>Visualizza <span class="text-pink">i tuoi ordini</span></div>
          <img
        ...
        >
          ...
          >
            <div
              ...
              :key="school"
              class="bg-white shadow-card rounded-2xl p-8 outline outline-5 outline-brown outline-offset-4 shadow-card hover:shadow-none transition-all duration-500 max-w-[350px] md:max-w-96"
            >
...
const toggleOrderPrepared = async (
  ...
  try {
    ...
    console.log("Order prepared status toggled:", response.data);
  } catch (error) {
...
const toggleOrderDelivered = async (
  ...
  try {
    ...
    console.log("Order delivered status toggled:", response.data);
  } catch (error) {
