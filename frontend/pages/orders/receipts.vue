  ...
  <div>
    ...
    >
      <div class="text-4xl md:text-6xl lg:text-8xl text-center font-bold mb-4">
        <div>
          <span class="text-brown">Ecco</span> le tue
          <span class="text-purple">ricevute!</span>
        </div>
        <div class="flex justify-center items-center gap-2 md:gap-6">
          <div>Fatture a <span class="text-pink">fine mese</span></div>
          <img
      ...
      <div class="flex justify-center flex-wrap gap-8 py-16 px-6">
        <div v-for="receipt in receipts" :key="receipt.id">
          <div
            class="bg-white shadow-card rounded-2xl p-8 outline outline-5 outline-brown outline-offset-4 shadow-card hover:shadow-none transition-all duration-500 h-full w-full md:w-[480px]"
          >
