...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.iaBcPque.mjs').then(interopDefault),
  "plugins/vue-cal.ts": () => import('./vue-cal-styles.DUdm1lY3.mjs').then(interopDefault),
